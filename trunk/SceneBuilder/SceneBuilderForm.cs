...
namespace SceneBuilder
{
	...
	public class SceneBuilderForm : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.LinkLabel linkLabelCodeChamber;
		...
		private System.Windows.Forms.ImageList imageListTabButtons;
		private Paneller.ExpandingPanel expandingPanel1;
		private Paneller.ExpandingPanel expandingPanel2;
		private Paneller.ExpandingPanel expandingPanel3;
		private Paneller.ExpandingPanel expandingPanel5;
		private Paneller.ExpandingPanelContainer expandingPanelContainer1;
		private System.Windows.Forms.TabPage tabPageModify;
		private Paneller.ExpandingPanelContainer expandingPanelContainer2;
		...
		private ColourComboBox.ColourMap colourMapSpecular;
		private ColourComboBox.ColourMap colourMapEmission;
		private ColourComboBox.ColourMap colourMapDiffuse;
		private ColourComboBox.ColourMap colourMapAmbient;
		private Paneller.ExpandingPanel expandingPanelMaterial;
		...
		private Paneller.ExpandingPanel expandingPanelProperties;
		private Paneller.ExpandingPanel expandingPanelSelection;
		private Paneller.ExpandingPanel expandingPanel4;
        ...
        private Button buttonTestOpenGL3;
        private Button buttonTestOpenGL21;
		...
		public SceneBuilderForm()
		{
			...
			labelGLVendor.Text = openGLCtrlScene.OpenGL.GetString(OpenGL.VENDOR);
			labelGLRenderer.Text = openGLCtrlScene.OpenGL.GetString(OpenGL.RENDERER);
			labelGLVersion.Text = openGLCtrlScene.OpenGL.GetString(OpenGL.VERSION);

			string extensions = openGLCtrlScene.OpenGL.GetString(OpenGL.EXTENSIONS);
			int iStart = 0;
			do
			{
		...
		private void InitializeComponent()
		{
            ...
            this.expandingPanelContainer1 = new Paneller.ExpandingPanelContainer();
            this.expandingPanel1 = new Paneller.ExpandingPanel();
            ...
            this.expandingPanel2 = new Paneller.ExpandingPanel();
            ...
            this.expandingPanel3 = new Paneller.ExpandingPanel();
            ...
            this.expandingPanelContainer2 = new Paneller.ExpandingPanelContainer();
            this.expandingPanelMaterial = new Paneller.ExpandingPanel();
            ...
            this.colourMapSpecular = new ColourComboBox.ColourMap();
            this.label3 = new System.Windows.Forms.Label();
            this.colourMapEmission = new ColourComboBox.ColourMap();
            this.label2 = new System.Windows.Forms.Label();
            this.colourMapDiffuse = new ColourComboBox.ColourMap();
            this.label1 = new System.Windows.Forms.Label();
            this.colourMapAmbient = new ColourComboBox.ColourMap();
            this.expandingPanelProperties = new Paneller.ExpandingPanel();
            this.expandingPanelSelection = new Paneller.ExpandingPanel();
            ...
            this.columnHeadeMask = new System.Windows.Forms.ColumnHeader();
            ...
            this.linkLabelCodeChamber = new System.Windows.Forms.LinkLabel();
            this.imageListTabButtons = new System.Windows.Forms.ImageList(this.components);
            this.buttonTestOpenGL21 = new System.Windows.Forms.Button();
            this.buttonTestOpenGL3 = new System.Windows.Forms.Button();
            ...
            this.openGLCtrlScene.DrawRenderTime = false;
            this.openGLCtrlScene.FrameRate = 10F;
            this.openGLCtrlScene.GDIEnabled = false;
            ...
            this.openGLCtrlScene.SceneDesignMode = true;
            ...
            // tabPageHierarchy
            // 
            this.tabPageHierarchy.Controls.Add(this.treeViewScene);
            this.tabPageHierarchy.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.tabPageHierarchy.Location = new System.Drawing.Point(4, 29);
            this.tabPageHierarchy.Name = "tabPageHierarchy";
            this.tabPageHierarchy.Size = new System.Drawing.Size(272, 391);
            this.tabPageHierarchy.TabIndex = 0;
            this.tabPageHierarchy.Text = "Tree";
            // 
            // treeViewScene
            // 
            ...
            // tabControlTools
            // 
            this.tabControlTools.Controls.Add(this.tabPageHierarchy);
            ...
            this.tabControlTools.Controls.Add(this.tabPageCredits);
            ...
            this.tabControlTools.ImageList = this.imageListTabButtons;
            ...
            this.colourMapSpecular.CurrentColour = System.Drawing.Color.Red;
            this.colourMapSpecular.Location = new System.Drawing.Point(72, 152);
            this.colourMapSpecular.Name = "colourMapSpecular";
            this.colourMapSpecular.ShowColourBorder = true;
            this.colourMapSpecular.Size = new System.Drawing.Size(160, 32);
            this.colourMapSpecular.TabIndex = 15;
            this.colourMapSpecular.ColourChanged += new ColourComboBox.ColourChangedHandler(this.colourMapSpecular_ColourChanged);
            // 
            // label3
            // 
            ...
            this.colourMapEmission.CurrentColour = System.Drawing.Color.Red;
            this.colourMapEmission.Location = new System.Drawing.Point(72, 112);
            this.colourMapEmission.Name = "colourMapEmission";
            this.colourMapEmission.ShowColourBorder = true;
            this.colourMapEmission.Size = new System.Drawing.Size(160, 32);
            this.colourMapEmission.TabIndex = 13;
            this.colourMapEmission.ColourChanged += new ColourComboBox.ColourChangedHandler(this.colourMapEmission_ColourChanged);
            // 
            // label2
            // 
            ...
            this.colourMapDiffuse.CurrentColour = System.Drawing.Color.Red;
            this.colourMapDiffuse.Location = new System.Drawing.Point(72, 72);
            this.colourMapDiffuse.Name = "colourMapDiffuse";
            this.colourMapDiffuse.ShowColourBorder = true;
            this.colourMapDiffuse.Size = new System.Drawing.Size(160, 32);
            this.colourMapDiffuse.TabIndex = 11;
            this.colourMapDiffuse.ColourChanged += new ColourComboBox.ColourChangedHandler(this.colourMapDiffuse_ColourChanged);
            // 
            // label1
            // 
            ...
            this.colourMapAmbient.CurrentColour = System.Drawing.Color.Red;
            this.colourMapAmbient.Location = new System.Drawing.Point(72, 32);
            this.colourMapAmbient.Name = "colourMapAmbient";
            this.colourMapAmbient.ShowColourBorder = true;
            this.colourMapAmbient.Size = new System.Drawing.Size(160, 32);
            this.colourMapAmbient.TabIndex = 9;
            this.colourMapAmbient.ColourChanged += new ColourComboBox.ColourChangedHandler(this.colourMapAmbient_ColourChanged);
            // 
            ...
            // tabPageStats
            // 
            this.tabPageStats.Controls.Add(this.buttonTestOpenGL3);
            this.tabPageStats.Controls.Add(this.buttonTestOpenGL21);
            ...
            // tabPageCredits
            // 
            this.tabPageCredits.Controls.Add(this.label11);
            this.tabPageCredits.Controls.Add(this.label10);
            this.tabPageCredits.Controls.Add(this.linkLabelCodeChamber);
            this.tabPageCredits.Location = new System.Drawing.Point(4, 29);
            this.tabPageCredits.Name = "tabPageCredits";
            this.tabPageCredits.Size = new System.Drawing.Size(272, 391);
            this.tabPageCredits.TabIndex = 3;
            this.tabPageCredits.Text = "Creds.";
            // 
            // label11
            // 
            ...
            this.label11.Text = "Optimisation and debugging by Lee Davies.";
            // 
            // label10
            // 
            ...
            this.label10.Size = new System.Drawing.Size(256, 48);
            this.label10.TabIndex = 7;
            this.label10.Text = "SharpGL and the SceneBuilder developed and created by Dave Kerr.";
            // 
            // linkLabelCodeChamber
            // 
            this.linkLabelCodeChamber.Location = new System.Drawing.Point(8, 8);
            this.linkLabelCodeChamber.Name = "linkLabelCodeChamber";
            this.linkLabelCodeChamber.Size = new System.Drawing.Size(256, 80);
            this.linkLabelCodeChamber.TabIndex = 6;
            this.linkLabelCodeChamber.TabStop = true;
            this.linkLabelCodeChamber.Text = "SharpGL is free and Open Source. Go to www.dopecode.co.uk for free updates, downl" +
                "oads, news and tutorials.";
            this.linkLabelCodeChamber.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabelCodeChamber_LinkClicked);
            // 
            // imageListTabButtons
            // 
            this.imageListTabButtons.ImageStream = ((System.Windows.Forms.ImageListStreamer)(resources.GetObject("imageListTabButtons.ImageStream")));
            this.imageListTabButtons.TransparentColor = System.Drawing.Color.Transparent;
            this.imageListTabButtons.Images.SetKeyName(0, "");
            // 
            // buttonTestOpenGL21
            // 
            this.buttonTestOpenGL21.Location = new System.Drawing.Point(16, 248);
            this.buttonTestOpenGL21.Name = "buttonTestOpenGL21";
            this.buttonTestOpenGL21.Size = new System.Drawing.Size(140, 23);
            this.buttonTestOpenGL21.TabIndex = 9;
            this.buttonTestOpenGL21.Text = "Test OpenGL 2.1";
            this.buttonTestOpenGL21.UseVisualStyleBackColor = true;
            this.buttonTestOpenGL21.Click += new System.EventHandler(this.buttonTestOpenGL21_Click);
            // 
            // buttonTestOpenGL3
            // 
            this.buttonTestOpenGL3.Location = new System.Drawing.Point(16, 280);
            this.buttonTestOpenGL3.Name = "buttonTestOpenGL3";
            this.buttonTestOpenGL3.Size = new System.Drawing.Size(140, 23);
            this.buttonTestOpenGL3.TabIndex = 9;
            this.buttonTestOpenGL3.Text = "Test OpenGL 3";
            this.buttonTestOpenGL3.UseVisualStyleBackColor = true;
            // 
            // SceneBuilderForm
            // 
            ...
            this.Text = "DopeCode SharpGL - Scene Builder 1.8";
		...
		private void buttonImportPoly_Click(object sender, System.EventArgs e)
		{
			...
			object data = engine.UserLoad(typeof(PolygonCollection));
			if(data != null)
			{
				PolygonCollection polys = data as PolygonCollection;
		...
		{
			//	Reference the hits.
			InteractableCollection hits = openGLCtrlScene.Hits;

			//	Remove any object that is not allowed.
			InteractableCollection newHits = new InteractableCollection();
		...
		private void linkLabelCodeChamber_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			linkLabelCodeChamber.LinkVisited = true;
			System.Diagnostics.Process.Start("http://www.dopecode.co.uk");
		}
		...
		private SceneObject currentMaterialsObject = null;
		...
		Material CurrentMaterial
		{
			set 
			{
				...
				colourMapAmbient.CurrentColour = currentMaterial.Ambient;
				colourMapDiffuse.CurrentColour = currentMaterial.Diffuse;
				colourMapEmission.CurrentColour = currentMaterial.Emission;
				colourMapSpecular.CurrentColour = currentMaterial.Specular;
		...
		private void colourMapAmbient_ColourChanged(object sender, ColourComboBox.ColourEventArgs e)
		{
			if(currentMaterial != null)
			{
				currentMaterial.Ambient = colourMapAmbient.CurrentColour;
				currentMaterialsObject.Modified = true;
				openGLCtrlScene.Invalidate();
			}
		}

		private void colourMapDiffuse_ColourChanged(object sender, ColourComboBox.ColourEventArgs e)
		{
			if(currentMaterial != null)
			{
				currentMaterial.Diffuse = colourMapDiffuse.CurrentColour;
				currentMaterialsObject.Modified = true;
				openGLCtrlScene.Invalidate();
			}
		}

		private void colourMapEmission_ColourChanged(object sender, ColourComboBox.ColourEventArgs e)
		{
			if(currentMaterial != null)
			{
				currentMaterial.Emission = colourMapEmission.CurrentColour;
				currentMaterialsObject.Modified = true;
				openGLCtrlScene.Invalidate();
			}
		}

		private void colourMapSpecular_ColourChanged(object sender, ColourComboBox.ColourEventArgs e)
		{
			if(currentMaterial != null)
			{
				currentMaterial.Specular = colourMapSpecular.CurrentColour;
				currentMaterialsObject.Modified = true;
				openGLCtrlScene.Invalidate();
			}
		}	
		...
		private void buttonSpherer_Click(object sender, System.EventArgs e)
		{
			...
			openGLCtrlScene.StartBuilding(new SharpGL.SceneGraph.Interaction.SphereBuilder());
		}
		
		private void buttonBuildPlane_Click(object sender, System.EventArgs e)
		{
			//	Set a plane builder.
			openGLCtrlScene.StartBuilding(new SharpGL.SceneGraph.Interaction.PlaneBuilder());
		}
